...
# Використовується, для емоджі і т.д.

message = "Привет мир! Hello world!"
print(message.encode())  # UTF-8 -> (by default) кодує в байти
# результат: b'\xcf\xf0 => \х - шістнадцяткове число, b' - бінарний код

# З цим можна зіткнутись коли потрібно парсити смс
